...
contract StarLight is Ownable, ERC721Enumerable, ERC721Burnable, ReentrancyGuard {
    ...
    uint256 public constant MAX_Starlight = 10000;
    uint256 public constant star_price1 = 0.05 ether;
    uint256 public constant star_price2 = 0.08 ether;
    ...
    constructor() ERC721("Star Light", "STLI") {
        // reserveTokens(50);
    }
    ...
    function mint(uint256 _numStar, string memory _baseTokenURI) public payable {
        ...
        require(_numStar <= 20, "Only 20 rooms can be minted at a time");
        require(nextId + _numStar <= MAX_Starlight, "Mint amount exceeds supply");
        require(msg.value >= star_price1 * _numStar, "Price not met");

        for(uint i = 0; i < _numStar; i++) {
